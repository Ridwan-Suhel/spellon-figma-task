...
Write a function that make api call to
        https://jsonplaceholder.typicode.com/photos

        And display only even id albums if today date is monday,
        wednesday, friday.

        Display odd id albums if today date is sunday, tuesday,
        thursday, saturday.

        if albumId + id mod 3 is 0, draw red border around the image.
